...
const Auth = () => {
  ...
  useEffect(() => {
    ...
    // Only redirect if user is authenticated AND we're not processing OAuth callback
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription>
            Sign in to access your AI personas and chat interface
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="text-center text-sm text-muted-foreground">
            By signing in, you agree to access your personalized AI chat experience
          </div>
        </CardContent>
      </Card>
    </div>
