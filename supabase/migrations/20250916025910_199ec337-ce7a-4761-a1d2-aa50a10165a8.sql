-- Rename knowledge_entries table to past_journals_full
ALTER TABLE knowledge_entries RENAME TO past_journals_full;

-- Insert the introductory note
INSERT INTO past_journals_full (title, content, entry_type, source_file, tags)
VALUES (
...
Love, Boss',
  'introduction',
  'journal_Doc_1-3.md',
  ARRAY['boss', 'introduction', 'context']
);